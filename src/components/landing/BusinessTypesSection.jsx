        ...
        <div>
          ...
          <div className="mt-8 space-y-6">
            <div>
              ...
              <p className="mt-2 text-[14px] text-slate-600">{t.businessTypes.items[0].text}</p>
            </div>
            <div>
              <h4 className="text-[24px] font-bold text-slate-900">{t.businessTypes.items[1].title}</h4>
              <p className="mt-2 text-[14px] text-slate-600">{t.businessTypes.items[1].text}</p>
            </div>
            <div>
              <h4 className="text-[24px] font-bold text-slate-900">{t.businessTypes.items[2].title}</h4>
              <p className="mt-2 text-[14px] text-slate-600">{t.businessTypes.items[2].text}</p>
            </div>
          </div>
        </div>
