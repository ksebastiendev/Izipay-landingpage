  ...
  return (
    <section className="bg-white py-20 lg:py-24">
      <div className="mx-auto grid w-full items-center gap-10 px-[0.8rem] sm:px-[0.9rem] md:px-[1.2rem] max-w-[600px] md:max-w-[720px] lg:max-w-[960px] xl:max-w-[1180px] 2xl:max-w-[1400px] lg:grid-cols-[minmax(0,1.1fr)_minmax(0,0.9fr)] lg:gap-12 xl:gap-16">
        <img src="/productsPage/wayto-section.png" alt={t.simpleWay.imageAlt} className="w-full max-w-[620px] lg:max-w-[700px]" />
        <div>
          <h3 className="max-w-[470px] text-[42px] font-extrabold leading-[1.05] tracking-[-0.03em] text-slate-900 lg:text-[48px]">{t.simpleWay.title}</h3>
