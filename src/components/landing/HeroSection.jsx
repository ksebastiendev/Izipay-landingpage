...
export default function HeroSection() {
  ...
  return (
    <section className="bg-[#f6f7fb]">
      <div className="mx-auto grid w-full max-w-[1120px] items-end gap-6 px-4 pt-20 pb-[10px] md:px-5 md:pt-24 lg:grid-cols-[minmax(0,480px)_minmax(0,1fr)] lg:gap-4 lg:pt-24 xl:pt-28">
        <div className="max-w-[540px] pb-3 lg:pb-8">
          ...
          <p className="mt-6 max-w-[510px] text-[18px] leading-[1.55] text-slate-600">
            {t.hero.description}
          </p>
        ...
        <div className="relative flex justify-center lg:justify-end">
          <img src="/landing/hero-section.png" alt={t.hero.imageAlt} className="w-full max-w-[640px] lg:max-w-[750px]" />
        </div>
      </div>
    </section>
  )
