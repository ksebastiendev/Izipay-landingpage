export const translations = {
  ...
  EN: {
    ...
    simpleWay: {
      title: 'A Simple Way to Accept Crypto Payments',
      description:
        'Integrate IzichangePay into your website, app, or online store and start accepting cryptocurrency payments in minutes.',
    ...
    testimonials: {
      ...
      items: [
        {
          text: 'IzichangePay transformed how I accept online payments. Integration is intuitive and the team provides 5/5 support. Highly recommended!',
          name: 'Sophie B',
          role: 'Merchant',
        },
        {
          text: 'I am an independent developer and IzichangePay has been a major asset to simplify crypto payments and automatically convert them for me.',
          name: 'Maxime L',
          role: 'Developer',
        },
        {
          text: 'IzichangePay customer support is amazing. They were very responsive and solved every issue quickly. I feel safe using their platform.',
          name: 'Emma R',
          role: 'Freelancer',
        },
      ],
